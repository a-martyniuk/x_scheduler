...
export const ScrapedDataView: React.FC<ScrapedDataViewProps> = ({ posts }) => {
    ...
    return (
        ...
        >
            ...
            <div className="bg-white/60 dark:bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-xl overflow-hidden">
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-border/10 bg-white/40 dark:bg-white/5">
                                ...
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground w-1/3">Contenido</th>
                                <th
                                    className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground cursor-pointer hover:text-primary transition-colors text-center"
                                ...
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground text-right">Link</th>
                            </tr>
                        </thead>
